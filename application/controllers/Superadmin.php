...
<div class="btn-group chat-btn-wrapper" id="chat-wrapper-' . $dp->id_pelaporan . '">
    ...
    public function sla()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/superadmin_sidebar');
        $this->load->view('superadmin/sla', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function rekapProgres()
    {
        ...
        $this->load->view('templates/header');
        $this->load->view('templates/superadmin_sidebar');
        $this->load->view('superadmin/rekap_progres', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function rekapKategori()
    {
        ...
        $data['rekap_kategori']   = $this->pelaporan_model->get_rekap_kategori($periode, $tahun, $nama_klien);
        $data['klien']   = $this->client_model->getClient();
        $data['periode'] = $periode;
        $data['tahun']   = $tahun;
        $data['nama_klien'] = $nama_klien;
    ...
    // Endpoint: daftar unread chat per tiket (untuk dropdown di sidebar)
