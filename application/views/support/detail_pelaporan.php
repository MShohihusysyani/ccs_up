    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <?php echo form_open_multipart('support/add_comment') ?>
                    <form>
                        <?php foreach ($datapelaporan as $dp) : ?>
                            ...
                            <a href="<?= base_url('support/pelaporan') ?>" type="button" class="btn btn-primary m-t-15 waves-effect">Kembali</a>
                    ...
                    foreach ($datacomment as $dc) { ?>
                        <div class="body">
                            ...
                            <div id="<?= $dc['id_comment']; ?>hiddenFormInput" style="display: none;">
                                <?php echo form_open_multipart('support/add_reply') ?>
