                ...
                <div class="body">
                    <form>
                        <?php foreach ($datapelaporan as $dp) : ?>
                            ...
                            <textarea id="editor_perihal" class="form-control" name="perihal" id="perihal" readonly>
                                <?= $dp['perihal']; ?>
                            </textarea>
                            <!-- <label for="perihal">Perihal</label>
                            <div class="form-group">
                            ...
                            <!-- <a href="<?= base_url('superadmin/finish') ?>" type="button" class="btn btn-primary m-t-15 waves-effect">kembali</a> -->
                        <?php endforeach; ?>
                    </form>
                </div>
            </div>
...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("editor_perihal"), {
