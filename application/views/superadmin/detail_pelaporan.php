    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="body">
                    <?php echo form_open_multipart('superadmin/add_comment') ?>
                    ...
                    foreach ($datacomment as $dc) { ?>
                        <div class="body">
                            ...
                            <div id="<?= $dc['id_comment']; ?>hiddenFormInput" style="display: none;">
                                <?php echo form_open_multipart('superadmin/add_reply') ?>
...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
        ...
        ckfinder: {
            uploadUrl: "<?= base_url('superadmin/upload_comment') ?>"
        },
    ...
    foreach ($datacomment as $dc) { ?>
        <script>
            ...
            CKEDITOR.ClassicEditor.create(document.getElementById("<?= $dc['id_comment']; ?>reply"), {
                ...
                ckfinder: {
                    uploadUrl: "<?= base_url('superadmin/upload_reply') ?>"
                },
                // https://ckeditor.com/docs/ckeditor5/latest/features/mentions.html#configuration
                mention: {
                    feeds: [{
