...
<script type="text/javascript">
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo base_url('implementator/fetch_data'); ?>",
            "type": "POST",
            "data": function(data) {
    ...
    function exportData(format) {
        ...
        var actionUrl = format === 'pdf' ? '<?php echo base_url('export/export_pdf_teknisi'); ?>' : '<?php echo base_url('export/export_excel_teknisi'); ?>';
