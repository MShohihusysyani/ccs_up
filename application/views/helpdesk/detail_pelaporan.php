            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <?php foreach ($datapelaporan as $dp) : ?>
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                ...
                                if (!empty($file_finish)) {
                                    ...
                                    $file_name = basename($file_finish);
                        ...
                        <textarea id="editor_finish" class="form-control" name="catatan_finish" id="catatan_finish" required>

                        </textarea>
                        <br>

                        <label for="nama">File Finish (jpg/jpeg/png/pdf/xlsx/docx) max 2mb</label>
                        <div class="form-group">
                    ...
                    foreach ($datacomment as $dc) { ?>
                        <div class="body">
                            <div class="panel panel-default">
                                <div class="panel-heading"> <b><?= $dc['nama_user']; ?></b> <?= format_indo($dc['created_at']) ?></div>
                            ...
                            <div id="<?= $dc['id_comment']; ?>hiddenFormInput" style="display: none;">
                                <?php echo form_open_multipart('helpdesk/add_reply') ?>
                                <label for="comment">Reply Comment</label>
                                <textarea id="<?= $dc['id_comment']; ?>reply" class="form-control" name="body" id="body">
...
<script>
    ...
    // Event untuk tombol Tambah Komen
    document.getElementById('tambah-komen').addEventListener('click', function() {
        form.action = "<?= base_url('helpdesk/add_comment') ?>";
        form.submit();
    });

    // Event untuk tombol Forward
    document.getElementById('forward').addEventListener('click', function() {
        form.action = "<?= base_url('helpdesk/fungsi_forward') ?>";
        form.submit();
    });

    // Event untuk tombol Finish
    document.getElementById('finish').addEventListener('click', function() {
        form.action = "<?= base_url('helpdesk/finish') ?>";
        form.submit();
    });
</script>
...
<?php if (empty($datacomment)) {
    ...
    foreach ($datacomment as $dc) { ?>
        <script>
            // This sample still does not showcase all CKEditor&nbsp;5 features (!)
            // Visit https://ckeditor.com/docs/ckeditor5/latest/features/index.html to browse all the features.
            CKEDITOR.ClassicEditor.create(document.getElementById("<?= $dc['id_comment']; ?>reply"), {
                // https://ckeditor.com/docs/ckeditor5/latest/features/toolbar/toolbar.html#extended-toolbar-configuration-format
                toolbar: {
                    items: [
                        '|',
...
<script>
    // This sample still does not showcase all CKEditor&nbsp;5 features (!)
    // Visit https://ckeditor.com/docs/ckeditor5/latest/features/index.html to browse all the features.
    CKEDITOR.ClassicEditor.create(document.getElementById("editor_finish"), {
        // https://ckeditor.com/docs/ckeditor5/latest/features/toolbar/toolbar.html#extended-toolbar-configuration-format
        toolbar: {
            items: [
                'findAndReplace', 'selectAll', '|',
