...
<script>
    var table = $('#example').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "<?php echo site_url('helpdesk/get_data_finish') ?>",
            "type": "POST",
            "data": function(data) {
    ...
    function exportData(format) {
        ...
        var actionUrl = format === 'pdf' ? '<?php echo base_url('export/rekap_pelaporan_pdf_hd'); ?>' : '<?php echo base_url('export/rekap_pelaporan_excel_hdfinish'); ?>';
