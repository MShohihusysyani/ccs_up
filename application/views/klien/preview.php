                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" name="tags" id="tags"
                                    value="<?= $tmp['tags']; ?>" class="form-control ui-autocomplete-input"
                                    readonly>
                            </div>
                        </div>
