                ...
                <div class="body">
                    <form>
                        <?php foreach ($datapelaporan as $dp) : ?>
                            ...
                            <label for="waktu_finish">Finish At</label>
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" id="waktu_finish" name="waktu_finish" class="form-control" value="<?= tanggal_indo($dp['waktu_finish']); ?>" readonly>
                                </div>
                            </div>
                            ...
                            <a href="<?= base_url('supervisor2/finish') ?>" type="button" class="btn btn-primary m-t-15 waves-effect">kembali</a>
                        <?php endforeach; ?>
                    </form>
                </div>
            </div>
