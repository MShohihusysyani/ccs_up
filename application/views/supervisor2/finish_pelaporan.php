            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <?php foreach ($datapelaporan as $dp) : ?>
                        ...
                        <label for="alasan_tolak">Alasan Tolak</label>
                        ...
                        <a href="<?= base_url('supervisor2/close') ?>" type="button" class="btn btn-primary m-t-15 waves-effect">Kembali</a>

                        <button type="submit" id="approve" class="btn btn-success m-t-15 waves-effect">Approve</button>
                        <button type="submit" id="reject" class="btn btn-warning m-t-15 waves-effect">Reject</button>
                    <?php endforeach; ?>
...
<script>
    ...
    document.getElementById('approve').addEventListener('click', function() {
        form.action = "<?= base_url('supervisor2/fungsi_approve_pelaporan') ?>";
        form.submit();
    });

    // Event untuk tombol Finish
    document.getElementById('reject').addEventListener('click', function() {
        form.action = "<?= base_url('supervisor2/fungsi_reject') ?>";
        form.submit();
    });
</script>
