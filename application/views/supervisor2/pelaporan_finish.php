                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class=" display table table-bordered table-striped table-hover dataTable" id="example">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>No Tiket</th>
...
<script>
    ...
    function exportData(format) {
        ...
        var actionUrl = format === 'pdf' ? '<?php echo base_url('export/export_pdf_finished'); ?>' : '<?php echo base_url('export/rekap_pelaporan_excel_finish'); ?>';
