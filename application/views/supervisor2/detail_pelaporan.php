                ...
                <div class="body">
                    ...
                    <form>
                        <?php foreach ($datapelaporan as $dp) : ?>
                            ...
                            <a href="<?= base_url('supervisor2/onprogress') ?>" type="button" class="btn btn-primary m-t-15 waves-effect">Kembali</a>
...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("editor"), {
        ...
        ckfinder: {
            uploadUrl: "<?= base_url('supervisor2/upload_comment') ?>"
        },
...
<script>
    ...
    CKEDITOR.ClassicEditor.create(document.getElementById("editor3"), {
        ...
        ckfinder: {
            uploadUrl: "<?= base_url('supervisor2/upload_reply') ?>"
        },
        // https://ckeditor.com/docs/ckeditor5/latest/features/mentions.html#configuration
        mention: {
            feeds: [{
