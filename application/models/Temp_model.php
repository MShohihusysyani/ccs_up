...
class Temp_model extends CI_Model
{
    ...
    {
        $query = "SELECT 	id_temp,  user_id, perihal, no_tiket, file, nama_klien, kategori, tags
    ...
    public function getTiketTemp1()
    {
        ...
        $query = "SELECT user.nama_user,tiket_temp.id_temp,  tiket_temp.no_tiket, tiket_temp.perihal, tiket_temp.file, user.id_user, tiket_temp.kategori, tiket_temp.tags
